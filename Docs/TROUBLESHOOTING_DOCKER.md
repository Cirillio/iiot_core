...
*   В конфигурацию клиента (`IIoT.Collector/appsettings.json`) и Docker Compose добавлены настройки для работы с нестандартным портом.
...
**Решение:** Даунгрейд пакета до стабильной версии **6.5.0** в `IIoT.WebApi.csproj`.
